...
const ENTRIES = [
  ...
  {
    id: "escape-from-pong",
    file: "Escape_from_Pong.nes",
    title: "Escape from Pong",
    author: "Adam Gashlin / HCS",
    license: "BSD-3",
    mapper: 0,
    group: "sample",
    kind: "game",
    summary: "ピンポン球になってパドルと障害をかわし、画面外へ脱出する極小パズル（1K コンポ出身）。",
    howto: "十字キーで球を加速。白い壁は跳ね返り、赤い壁・パドルに当たるとやり直し。",
  },
  {
    id: "nes15",
    file: "NES15.nes",
    title: "NES15",
    author: "Mathew Brenaman",
    license: "BSD-2",
    mapper: 0,
    group: "sample",
    kind: "game",
    summary: "クラシックな15パズル（番号タイル並べ）。",
    howto: "十字キーで空きマスへタイルをスライド。自動ソルバーあり（画面案内参照）。",
  },
  {
    id: "dabg",
    file: "Double_Action_Blaster_Guys.nes",
    ...
    group: "sample",
    kind: "game",
    summary: "バブルボブル風の2人対応アクション。敵を撃って固め、触れて倒す。レベルエディタ付き。",
    howto: "十字キーで移動、A/B でジャンプ・攻撃。1〜2人。メニューからエディタや対戦も選べる。",
  },
  {
    id: "hype",
    file: "Hype.nes",
